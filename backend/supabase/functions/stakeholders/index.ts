...
/**
 * Edge function to handle external requests to fetch stakeholders.
 *
 * method: POST
 * path: /functions/v1/stakeholders
 * query params: { id?: string }
 * example:
 * /functions/v1/stakeholders
 * /functions/v1/stakeholders?id=1
 */
Deno.serve(async (req) => {
  ...
  try {
    ...
    const join = ["stakeholder_projects"];
