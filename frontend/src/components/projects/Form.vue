      ...
      <div class="space-y-12">
        ...
        >
          <div>
            ...
            <p class="mt-1 text-sm leading-6 text-gray-600">
              Collect overview information about a new project.
            </p>
          </div>
                ...
                >
                  <template #value="slotProps">
                    <div v-if="slotProps.value" class="flex align-items-center">
                      <CommonBadge
                        :severity="getProjectStatusBadge(slotProps.value.label)"
                        :text="slotProps.value.label"
                      />
                    </div>
                    <span v-else>
                  ...
                  <template #option="slotProps">
                    <div class="flex align-items-center">
                      <CommonBadge
                        :severity="getProjectStatusBadge(slotProps.option.label)"
                        :text="slotProps.option.label"
                      />
                    </div>
                  </template>
                </Dropdown>
        ...
        >
          ...
          <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
            ...
            <div class="sm:col-span-3">
              <label class="block text-sm font-medium leading-6 text-gray-900"
                >Committee Presentation Date</label
              >
              <div class="mt-2">
                <Calendar
                  v-model="committeePresentationDate"
                  showIcon
                  iconDisplay="input"
                  class="w-full"
                />
...
export default defineComponent({
  ...
  setup() {
    ...
    const projectStatuses = computed(() =>
      Object.entries(ProjectStatus).map(([key, value]) => ({ label: value, value: key }))
    )
